...
- Managing knowledge base articles (create, update, publish, audit)
- Exporting or bulk-updating help center content
- Building ticket-to-article workflows for self-service deflection
...
| `/solutions/categories` | Knowledge base categories |
| `/solutions/folders` | Knowledge base folders |
| `/solutions/articles` | Knowledge base articles (create, update, publish) |
| `/search/solutions` | Search knowledge base articles |
...
See [references/solutions-api.md](references/solutions-api.md) for knowledge base (Solutions) management.
...
- [Solutions API Reference](references/solutions-api.md) - Knowledge base categories, folders, articles (create/update/publish/search)
